              ...
              <div className="max-w-md mx-auto">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          required
                          className={`w-full pl-11 pr-10 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:border-[#ED1C3E] focus:ring-2 focus:ring-[#ED1C3E]/20 outline-none transition ${bengaliClass}`}
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                          className="absolute right-3 top-3.5 text-gray-400 hover:text-[#ED1C3E] transition"
                        >
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition ${termsAccepted ? 'bg-[#ED1C3E] border-[#ED1C3E]' : 'border-gray-300'}`}>
                    ...
                    <span className={`text-sm text-gray-600 ${bengaliClass}`}>
                      ...
                      <Link href="/terms" className="text-[#ED1C3E] font-medium hover:underline">
                        {language === "bn" ? "শর্তাবলী" : "Terms & Conditions"}
                      </Link>
                      {language === "bn" ? " এবং " : " and "}
                      <Link href="/privacy" className="text-[#ED1C3E] font-medium hover:underline">
                  ...
                  <p className={`text-sm text-gray-500 text-center ${bengaliClass}`}>
                    ...
                    <Link href="/login" className="text-[#ED1C3E] font-semibold hover:underline">
