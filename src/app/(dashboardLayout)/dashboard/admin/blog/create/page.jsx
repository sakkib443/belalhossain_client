                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium transition-all ${previewMode
                            ? 'bg-gradient-to-r from-rose-600 to-cyan-500 text-white'
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-rose-600 to-cyan-500 text-white font-semibold shadow-lg shadow-rose-600/30 hover:shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50"
                    >
                        {loading ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className={`p-6 rounded-2xl border ${isDark ? 'bg-slate-800/50 border-slate-700/50' : 'bg-white border-slate-200'}`}>
                        ...
                        {formData.thumbnail ? (
                            ...
                            <label className={`flex flex-col items-center justify-center h-48 border-2 border-dashed rounded-xl cursor-pointer transition-colors ${isDark
                                ? 'border-slate-600 hover:border-rose-600 hover:bg-slate-700/50'
                                : 'border-slate-300 hover:border-rose-600 hover:bg-slate-50'
                                }`}>
                    ...
                    <div className={`p-6 rounded-2xl border ${isDark ? 'bg-slate-800/50 border-slate-700/50' : 'bg-white border-slate-200'}`}>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                onClick={addTag}
                                className="px-3 py-2 rounded-lg bg-rose-600 text-white hover:bg-rose-700 transition-colors"
                            >
                                <FiTag size={16} />
                            </button>
                        </div>
