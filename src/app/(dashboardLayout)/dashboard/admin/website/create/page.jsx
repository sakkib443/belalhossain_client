...
export default function CreateWebsitePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const catRes = await fetch(`${API_BASE_URL}/categories?type=website`);
    ...
    const onSubmit = async (values) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/websites/admin`, {
                method: 'POST',
                headers: {
        ...
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-500 to-rose-600 flex items-center justify-center shadow-lg shadow-emerald-500/25">
                ...
                <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-rose-600 hover:from-emerald-600 hover:to-rose-700 text-white px-5 py-2.5 rounded-xl font-semibold text-sm shadow-lg shadow-emerald-500/25 transition-all disabled:opacity-50"
                >
                    ...
                    <div className={cardClass}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {/* Image Preview Grid */}
                                {watchImages.filter(img => img && img.trim() !== '').length > 0 && (
