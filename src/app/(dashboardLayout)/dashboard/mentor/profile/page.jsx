                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-white to-[#FD9A00] rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-1 bg-[#FD9A00]/20 text-[#FD9A00] text-[10px] font-bold rounded-md uppercase">
                                            Mentor
                                        </span>
                                    </div>
                                </div>
