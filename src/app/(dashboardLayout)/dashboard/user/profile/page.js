...
export default function UserProfilePage() {
    ...
    const inputClass = `w-full px-4 py-3.5 rounded-2xl border-2 outline-none transition-all text-sm font-medium ${isDark
        ? 'bg-slate-800/50 border-slate-700/50 text-white focus:border-[#FD9A00] focus:bg-slate-800'
        : 'bg-white border-slate-200 text-slate-800 focus:border-[#FD9A00] focus:shadow-lg focus:shadow-[#FD9A00]/10'
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#FD9A00] via-[#3aa8a1] to-[#FD9A00]" />
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#FD9A00] to-[#FD9A00] rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-2 -right-2 w-12 h-12 rounded-2xl bg-white text-[#FD9A00] flex items-center justify-center shadow-xl hover:scale-110 transition-transform border-4 border-[#FD9A00]"
                                >
                                    <FiCamera size={20} />
                                </button>
                            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { icon: FiBook, label: 'Enrolled Courses', value: '0', color: 'from-[#FD9A00] to-[#3aa8a1]' },
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`rounded-3xl overflow-hidden ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            <div className="p-6 bg-gradient-to-br from-[#FD9A00] to-[#3aa8a1]">
                        ...
                        <div className={`rounded-3xl p-6 ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            ...
                            <div className="space-y-3">
                                <button className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all ${isDark ? 'bg-slate-700/50 hover:bg-slate-700 text-white' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'}`}>
                                    <FiLock size={18} className="text-[#FD9A00]" />
                        ...
                        <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 border-b ${isDark ? 'border-slate-700/50' : 'border-slate-100'}`}>
                            ...
                            {!isEditing ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-[#FD9A00] hover:bg-[#3aa8a1] text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-[#FD9A00]/25"
                                >
                                    <FiEdit3 size={16} />
                                    Edit Profile
                                </button>
