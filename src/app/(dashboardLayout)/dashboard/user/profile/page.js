...
export default function UserProfilePage() {
    ...
    const inputClass = `w-full px-4 py-3.5 rounded-2xl border-2 outline-none transition-all text-sm font-medium ${isDark
        ? 'bg-slate-800/50 border-slate-700/50 text-white focus:border-[#ED1C3E] focus:bg-slate-800'
        : 'bg-white border-slate-200 text-slate-800 focus:border-[#ED1C3E] focus:shadow-lg focus:shadow-[#ED1C3E]/10'
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#ED1C3E] via-[#3aa8a1] to-[#FD9A00]" />
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#FD9A00] to-[#ED1C3E] rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-2 -right-2 w-12 h-12 rounded-2xl bg-white text-[#ED1C3E] flex items-center justify-center shadow-xl hover:scale-110 transition-transform border-4 border-[#ED1C3E]"
                                >
                                    <FiCamera size={20} />
                                </button>
                            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { icon: FiBook, label: 'Enrolled Courses', value: '0', color: 'from-[#ED1C3E] to-[#3aa8a1]' },
                        { icon: FiAward, label: 'Certificates', value: '0', color: 'from-[#FD9A00] to-[#e88a43]' },
                        { icon: FiHeart, label: 'Wishlist Items', value: '0', color: 'from-rose-500 to-pink-500' },
                        { icon: FiTrendingUp, label: 'Completed', value: '0%', color: 'from-emerald-500 to-rose-600' },
                    ].map((stat, idx) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`rounded-3xl overflow-hidden ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            <div className="p-6 bg-gradient-to-br from-[#ED1C3E] to-[#3aa8a1]">
                        ...
                        <div className={`rounded-3xl p-6 ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            ...
                            <div className="space-y-3">
                                <button className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all ${isDark ? 'bg-slate-700/50 hover:bg-slate-700 text-white' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'}`}>
                                    <FiLock size={18} className="text-[#ED1C3E]" />
                                ...
                                <button className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all ${isDark ? 'bg-slate-700/50 hover:bg-slate-700 text-white' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'}`}>
                                    <FiAward size={18} className="text-[#FD9A00]" />
                    ...
                    <div className={`lg:col-span-2 rounded-3xl ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                        ...
                        <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 border-b ${isDark ? 'border-slate-700/50' : 'border-slate-100'}`}>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#ED1C3E] to-[#FD9A00] flex items-center justify-center text-white">
                                    <FiUser size={22} />
                                </div>
                                <div>
                            ...
                            {!isEditing ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-[#ED1C3E] hover:bg-[#3aa8a1] text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-[#ED1C3E]/25"
                                >
                                    <FiEdit3 size={16} />
                                    Edit Profile
                                </button>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        onClick={handleSave}
                                        disabled={loading}
                                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#ED1C3E] to-[#FD9A00] text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-[#ED1C3E]/25 disabled:opacity-50"
                                    >
                                        <FiSave size={16} />
