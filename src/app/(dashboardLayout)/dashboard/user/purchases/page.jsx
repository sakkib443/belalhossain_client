        ...
        <div className="space-y-6">
                            ...
                            className={`px-3 py-2 rounded-xl text-xs font-bold transition-all capitalize ${statusFilter === status
                                ? status === 'completed'
                                    ...
                                    : status === 'pending'
                                        ...
                                        : isDark ? 'bg-[#ED1C3E]/20 text-[#ED1C3E] border border-[#ED1C3E]/30' : 'bg-[#ED1C3E]/10 text-[#ED1C3E] border border-[#ED1C3E]/20'
            ...
            {filteredOrders.length === 0 ? (
                <div className={`py-16 text-center ${cardClass}`}>
                    ...
                    {!searchTerm && statusFilter === 'all' && (
                        <Link
                            href="/courses"
                            className="inline-flex items-center gap-2 mt-5 px-5 py-2.5 bg-gradient-to-r from-[#ED1C3E] to-[#FD9A00] text-white rounded-xl font-bold text-sm shadow-md hover:scale-105 transition-all"
                        >
                ...
                <div className={`overflow-hidden ${cardClass}`}>
                    ...
                    <div className={`hidden md:grid grid-cols-12 gap-4 px-6 py-4 text-[10px] font-bold uppercase tracking-widest ${isDark
                        ...
                        <div className="col-span-3 flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-[#ED1C3E]"></span>
                            Order ID
                        </div>
                    ...
                    <div className="divide-y divide-slate-100 dark:divide-white/5">
                        {filteredOrders.map((order, idx) => (
                            <div key={order._id} className={`${expandedOrder === order._id ? isDark ? 'bg-slate-800/20' : 'bg-[#ED1C3E]/5' : ''}`}>
                                {/* Main Row */}
                                <div
                                ...
                                >
                                    ...
                                    <div className="hidden md:flex col-span-1 justify-center items-center">
                                        <button className={`p-2.5 rounded-xl transition-all ${expandedOrder === order._id
                                            ? isDark ? 'bg-[#ED1C3E]/10 text-[#ED1C3E]' : 'bg-[#ED1C3E]/10 text-[#ED1C3E]'
                                        ...
                                        <div className={`rounded-xl border overflow-hidden ${isDark ? 'border-white/5' : 'border-slate-200'}`}>
                                                        ...
                                                        <div className="text-right shrink-0">
                                                            ...
                                                            {order.paymentStatus === 'completed' && (
                                                                <Link
                                                                    ...
                                                                    className="text-[10px] font-bold text-[#ED1C3E] hover:underline"
                                                                >
                                                                    Access →
                                                                </Link>
                                                            )}
                                            ...
                                            <div className={`flex flex-wrap items-center justify-between gap-3 px-4 py-3 ${isDark ? 'bg-slate-800/50' : 'bg-slate-50'}`}>
                                                ...
                                                <button className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold transition-colors ${isDark
                                                    ...
                                                    : 'bg-white text-slate-500 hover:text-[#ED1C3E] border border-slate-200'
                                                    }`}>
            ...
            <div className={`p-5 rounded-2xl border flex items-center justify-between gap-4 ${isDark
                ...
                <div className="flex items-center gap-3">
                    <FiCreditCard size={18} className="text-[#ED1C3E] shrink-0" />
                    <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                        Need help with a payment? <Link href="/dashboard/user/support" className="text-[#ED1C3E] font-bold hover:underline">Contact Support</Link>
                    </p>
                </div>
            </div>
        </div>
