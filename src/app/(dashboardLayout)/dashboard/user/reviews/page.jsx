    ...
    return (
        <div className={`p-6 md:p-8 min-h-screen ${isDark ? 'text-white' : 'text-slate-800'}`}>
            <header className="mb-8 flex items-center justify-between border-b pb-6 border-slate-200/50 dark:border-slate-800/50">
                <div>
                    <h1 className="text-3xl font-bold font-outfit bg-gradient-to-r from-rose-600 to-amber-500 bg-clip-text text-transparent inline-block">
                        My Reviews
                    </h1>
                ...
                <div className={`px-4 py-2 rounded-lg text-sm font-medium ${isDark ? 'bg-slate-800 text-slate-300' : 'bg-white shadow-sm border border-slate-100 text-slate-600'}`}>
                    Total Reviews: <span className="font-bold text-rose-600">{myReviews.length}</span>
                </div>
            </header>
            ...
            {loading ? (
                    ...
                    {myReviews.map((review) => (
                        <div
                            ...
                            className={`group relative p-6 rounded-2xl border transition-all duration-300 ${isDark
                                ...
                                : 'bg-white border-slate-100 hover:border-rose-100 hover:shadow-lg hover:shadow-rose-600/5'
                                }`}
                        >
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Link
                                                ...
                                                className={`p-2 rounded-lg transition-colors ${isDark
                                                    ...
                                                    : 'hover:bg-slate-100 text-slate-400 hover:text-rose-700'
                                                    }`}
                                                title="View Product"
                                            >
                ...
                <div className={`flex flex-col items-center justify-center py-20 px-4 rounded-3xl border border-dashed text-center ${isDark ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-200'
                    ...
                    <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-rose-500/20 to-amber-400/20 flex items-center justify-center mb-6">
                        <LuLayoutGrid className="w-8 h-8 text-rose-600" />
                    </div>
                    ...
                    <Link
                        href="/"
                        className="px-8 py-3 rounded-xl bg-gradient-to-r from-rose-600 to-amber-500 text-white font-semibold shadow-lg shadow-rose-600/20 hover:shadow-rose-600/30 hover:scale-105 transition-all"
                    >
                        Explore Marketplace
                    </Link>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-rose-600/50 transition-all ${isDark ? 'bg-slate-800 border-slate-700 focus:bg-slate-800' : 'bg-slate-50 border-slate-200 focus:bg-white'
                                }`}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            required
                            className={`w-full px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-rose-600/50 transition-all resize-none ${isDark ? 'bg-slate-800 border-slate-700 focus:bg-slate-800' : 'bg-slate-50 border-slate-200 focus:bg-white'
                                }`}
                    ...
                    <div className="pt-4 flex justify-end gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="px-6 py-2.5 bg-gradient-to-r from-rose-600 to-amber-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-rose-600/20 active:scale-95 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
                        >
