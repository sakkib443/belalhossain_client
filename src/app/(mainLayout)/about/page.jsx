...
const MouseLight = () => {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 w-[600px] h-[600px] rounded-full bg-rose-600/[0.04] dark:bg-rose-600/[0.06] blur-[150px] pointer-events-none z-[1] hidden lg:block"
      style={{
...
const AboutPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-[#0F172A] selection:bg-rose-600 selection:text-black font-poppins antialiased">
      <MouseLight />

      {/* Scroll Progress Indicator */}
      <motion.div className="fixed top-0 left-0 w-full h-[3px] bg-rose-600/10 z-[10000]">
        <motion.div className="h-full bg-rose-600 origin-left" style={{ scaleX: scrollYProgress }} />
      </motion.div>
