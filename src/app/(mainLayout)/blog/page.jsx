        ...
        return (
            <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center">
                <motion.div
                    ...
                    className="w-12 h-12 border-4 border-[#ED1C3E]/30 border-t-[#ED1C3E] rounded-full"
                />
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] transition-colors duration-300">
            ...
            <section className="relative py-12 lg:py-16 overflow-hidden bg-white dark:bg-[#020202]">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-0 left-[15%] w-[400px] h-[400px] bg-gradient-to-br from-rose-600/15 to-cyan-500/5 rounded-full blur-3xl"></div>
                    <div className="absolute bottom-0 right-[15%] w-[350px] h-[350px] bg-gradient-to-br from-[#FD9A00]/10 to-amber-500/5 rounded-full blur-3xl"></div>
                    {/* Subtle Grid Pattern */}
                ...
                <div className="container mx-auto px-4 lg:px-16 relative z-10">
                    ...
                    >
                        {/* Simple Badge */}
                        <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-rose-600/10 border border-rose-600/20">
                            <FiBookOpen className="text-rose-600" size={14} />
                            <span className="text-xs font-semibold text-rose-700 dark:text-rose-500 uppercase tracking-wide">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight">
                            ...
                            <span className="text-rose-600">{language === 'bn' ? 'অনুপ্রেরণা' : 'Inspiration'}</span>
                        </h1>
            ...
            <div className="container mx-auto px-4 lg:px-16 py-8">
                                ...
                                <div className="bg-white dark:bg-white/5 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-white/10 h-full flex flex-col">
                                    ...
                                    <div className="relative h-[350px] overflow-hidden">
                                        {(featuredBlogs[0] || blogs[0]).thumbnail ? (
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-rose-700 to-cyan-700" />
                                        )}
                                        {/* Category Badge on Image */}
                                        <span className="absolute top-4 left-4 px-4 py-1.5 rounded-full bg-rose-600 text-white text-xs font-bold uppercase tracking-wide">
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        {/* Title */}
                                        <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3 leading-tight group-hover:text-rose-600 transition-colors line-clamp-2">
                                        ...
                                        <div className="flex items-center gap-4 text-sm pt-4 border-t border-gray-100 dark:border-white/10">
                                            <div className="flex items-center gap-2">
                                                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-rose-500 to-cyan-400 flex items-center justify-center text-white text-xs font-bold">
                                ...
                                <Link key={blog._id} href={`/blog/${blog.slug}`} className={`group flex-1 flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors ${index !== 3 ? 'border-b border-gray-100 dark:border-white/5' : ''}`}>
                                    <div className="w-20 h-20 relative rounded-lg overflow-hidden flex-shrink-0">
                                        {blog.thumbnail ? (
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-rose-100 to-cyan-100 dark:from-slate-600 dark:to-slate-700 flex items-center justify-center">
                                                <FiBookOpen className="text-rose-500 dark:text-slate-500" size={18} />
                                            </div>
                                        )}
                                    </div>
                                    <div className="flex-1 min-w-0 py-1">
                                        <h4 className="font-semibold text-gray-800 dark:text-white text-sm leading-snug line-clamp-1 group-hover:text-rose-600 transition-colors">
                                            {blog.title}
                                        </h4>
                ...
                {blogs.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/10">
                        <div className="w-20 h-20 mx-auto mb-6 bg-rose-600/10 rounded-2xl flex items-center justify-center">
                            <FiBookOpen className="text-rose-600" size={32} />
                        </div>
                        ...
                        {(activeTab === 'popular' ? popularBlogs : blogs).map((blog, index) => (
                            ...
                            >
                                <Link href={`/blog/${blog.slug}`} className="block">
                                    <div className="bg-white dark:bg-white/5 rounded-2xl overflow-hidden border border-gray-100 dark:border-white/10 hover:border-rose-600/30 dark:hover:border-rose-600/30 transition-all duration-500 hover:shadow-2xl hover:shadow-rose-600/10 hover:-translate-y-2">
                                        {/* Image Container */}
                                        <div className="relative h-52 overflow-hidden">
                                            {blog.thumbnail ? (
                                                ...
                                                <div className="w-full h-full bg-gradient-to-br from-rose-600/20 via-cyan-500/10 to-rose-600/5 dark:from-rose-600/10 dark:via-white/5 dark:to-cyan-500/5 flex items-center justify-center">
                                                    <FiBookOpen className="text-rose-500 dark:text-rose-600/50" size={40} />
                                                </div>
                                            )}
                                            {/* Gradient Overlay */}
                                            ...
                                            <div className="absolute top-4 right-4">
                                                <span className="px-3 py-1.5 rounded-lg bg-rose-600/90 backdrop-blur-md text-xs font-bold text-white flex items-center gap-1.5">
                                                    <FiClock size={12} />
                                                    5 {text.min}
                                                </span>
                                            </div>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex items-center gap-3 mb-4">
                                                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-rose-600 to-cyan-500 flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-rose-600/30">
                                            ...
                                            {/* Title */}
                                            <h3 className="text-lg font-bold text-gray-900 dark:text-white group-hover:text-rose-600 transition-colors duration-300 line-clamp-2 mb-3 leading-snug">
                                                {blog.title}
                                            </h3>
                                            ...
                                            <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-white/10">
                                                <span className="text-sm font-semibold text-rose-600 group-hover:text-rose-700 transition-colors flex items-center gap-2">
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center gap-3 mt-14">
                        <button
                            ...
                            className="w-12 h-12 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-600 dark:text-gray-400 disabled:opacity-40 hover:bg-rose-600 hover:border-rose-600 hover:text-white transition-all shadow-sm"
                        >
                        ...
                        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => i + 1).map((page) => (
                            <button
                                ...
                                className={`w-12 h-12 rounded-xl font-bold text-sm transition-all ${currentPage === page
                                    ...
                                    : 'bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-rose-600 hover:border-rose-600 hover:text-white'
                                    }`}
                            >
                                {page}
                            </button>
