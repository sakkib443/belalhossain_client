    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 lg:px-16">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white border border-gray-200 rounded-full shadow-sm">
              <LuAward className="text-[#FD9A00] text-lg" />
            ...
            <h1 className={`text-3xl lg:text-4xl font-bold outfit text-gray-800 mb-4 ${bengaliClass}`}>
              {t("certificationPage.title1")}<span className="text-[#ED1C3E]">{t("certificationPage.title2")}</span>
            </h1>
        ...
        <div className="bg-white border border-gray-200 rounded-md p-6 shadow-sm">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-md focus:ring-2 focus:ring-[#ED1C3E] focus:border-[#ED1C3E] outline-none transition-all text-sm"
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              disabled={isLoading}
              className={`flex items-center gap-2 px-6 py-3 bg-[#ED1C3E] hover:bg-[#38a89d] text-white font-medium rounded-md transition-all hover:shadow-lg disabled:opacity-50 ${bengaliClass}`}
            >
              {isLoading ? (
            ...
            {!hasSearched ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredUsers.map((user) => (
                  <div
                    key={user.id}
                    className="group bg-gray-50 border border-gray-200 rounded-md p-5 hover:shadow-lg hover:border-[#ED1C3E]/30 transition-all duration-300"
                  >
                    {/* Header */}
                    <div className="flex items-center gap-4 mb-4">
                      <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-[#ED1C3E]">
                        <Image
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-[#ED1C3E] hover:bg-[#38a89d] text-white text-sm font-medium rounded-md transition-colors ${bengaliClass}`}
                      >
                        <LuEye />
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-[#FD9A00] hover:bg-[#e68a47] text-white text-sm font-medium rounded-md transition-colors ${bengaliClass}`}
                      >
                        <LuDownload />
      ...
      <section className="container mx-auto px-4 lg:px-16 pt-6 pb-4">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-2 px-4 text-center md:flex-row md:justify-between md:text-left">
          ...
          <Link
            href="#"
            className={`flex items-center gap-2 rounded-full px-12 py-4 bg-white text-[#ED1C3E] font-bold hover:shadow-lg transition-all ${bengaliClass}`}
          >
      ...
      <section className="container mx-auto px-4 lg:px-16 pb-12">
        <div className="bg-gradient-to-r from-[#ED1C3E] to-[#38a89d] rounded-md p-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 px-6 py-3 bg-white text-[#ED1C3E] font-medium rounded-md hover:shadow-lg transition-all shrink-0 ${bengaliClass}`}
            >
