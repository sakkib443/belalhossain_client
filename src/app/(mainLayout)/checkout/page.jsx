        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="flex flex-col items-center gap-3">
                    <LuLoader className="animate-spin text-[#ED1C3E]" size={32} />
        ...
        return (
            <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
                ...
                <button
                    ...
                    className="px-6 py-3 bg-gray-900 text-white rounded-md font-semibold text-sm hover:bg-[#ED1C3E] transition-all flex items-center gap-2"
                >
    ...
    if (checkoutItems.length === 0) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 text-center">
                ...
                <button onClick={() => router.push('/courses')} className="px-6 py-3 bg-[#ED1C3E] text-white rounded-md font-semibold text-sm">
                    Browse Courses
                </button>
            </div>
        );
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-3">
                            <button onClick={() => router.back()} className="w-10 h-10 flex items-center justify-center bg-white rounded-md border border-gray-200 text-gray-400 hover:text-[#ED1C3E] transition-all">
                        ...
                        <div className="bg-white p-6 lg:p-8 rounded-md border border-gray-100 space-y-6">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-[#ED1C3E]/10 rounded-md flex items-center justify-center text-[#ED1C3E]">
                            ...
                            <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-md focus:border-[#ED1C3E] focus:bg-white outline-none transition-all text-sm"
                                    />
                                </div>
                                <div>
                                ...
                                <div className="md:col-span-2 pt-4 space-y-4">
                                    ...
                                    {paymentMethod === 'manual' && (
                                        ...
                                        >
                                            {isInstallmentActive && (
                                                <div className="flex items-center gap-2 p-3 bg-[#ED1C3E]/5 border border-[#ED1C3E]/20 rounded-md mb-4">
                                                    <div className="w-8 h-8 bg-[#ED1C3E] rounded flex items-center justify-center text-white shrink-0 shadow-sm">
                                                        <LuBadgeCheck size={16} />
                                                    </div>
                                                    <div>
                                                        <p className="text-xs font-black text-[#ED1C3E] uppercase tracking-tighter">Initial Payment Required</p>
                                                        <p className="text-[10px] text-[#ED1C3E]/60 font-medium">Pay exactly ৳{finalAmount.toLocaleString()} to activate your access</p>
                                                    </div>
                                                </div>
                                            )}
                                ...
                                <div className="md:col-span-2 pt-4">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full py-3.5 bg-[#ED1C3E] hover:bg-teal-500 disabled:bg-gray-300 text-white rounded-md font-semibold text-sm shadow-lg transition-all flex items-center justify-center gap-3"
                                    >
                                        {loading ? (
                            ...
                            <div className="pt-4 space-y-4 border-t border-gray-100">
                                        ...
                                        <div className="flex gap-2">
                                            <div className="flex-1 relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold uppercase focus:border-[#ED1C3E] outline-none transition-all"
                                                />
                                            </div>
                                            <button
                                                type="button"
                                                ...
                                                className="px-4 py-2.5 bg-slate-900 text-white font-bold text-xs rounded-xl hover:bg-[#ED1C3E] transition-all disabled:opacity-50"
                                            >
                                    ...
                                    <div className="py-5 space-y-4 border-t border-b border-slate-100 bg-slate-50/30 -mx-6 px-6">
                                        ...
                                        <div className="space-y-2.5">
                                            {installments.map((inst, idx) => {
                                                ...
                                                return (
                                                    <div key={idx} className={`flex justify-between items-center p-3 rounded-md border transition-all ${idx === 0 ? 'bg-white border-[#ED1C3E] shadow-sm' : 'bg-white border-slate-100 opacity-90'}`}>
                                                        <div className="flex items-center gap-3">
                                                            <div className={`w-6 h-6 flex items-center justify-center rounded-md text-[10px] font-semibold ${idx === 0 ? 'bg-[#ED1C3E] text-white' : 'bg-slate-100 text-slate-500'}`}>
                                                                {inst.installmentNumber}
                                                            </div>
                                                            <div>
                                                                <p className={`text-[10px] font-semibold uppercase tracking-tight leading-none mb-1 ${idx === 0 ? 'text-[#ED1C3E]' : 'text-slate-500'}`}>
                                                        ...
                                                        <div className="flex items-center gap-1.5">
                                                            ...
                                                            {isEditable ? (
                                                                <input
                                                                    ...
                                                                    className={`w-24 py-1.5 px-3 text-right text-sm font-medium rounded-md outline-none border transition-all ${idx === 0 ? 'bg-white border-[#ED1C3E]/30 text-[#ED1C3E]' : 'bg-slate-50 border-slate-200 text-slate-700 focus:border-[#ED1C3E]'}`}
                                                                />
                                                            ) : (
                                                                <span className={`text-sm font-medium ${idx === 0 ? 'text-[#ED1C3E]' : 'text-slate-700'}`}>
                                ...
                                <div className="pt-4 flex justify-between items-center border-t border-dashed border-slate-200">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <span className={`text-2xl font-bold ${isInstallmentActive ? 'text-[#ED1C3E]' : 'text-slate-800'}`}>
