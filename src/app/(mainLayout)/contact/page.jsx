    ...
    <div className="min-h-screen bg-white dark:bg-[#020202]">
      ...
      {messageSent && (
        <>
          ...
          >
            <div className="w-20 h-20 bg-gradient-to-r from-rose-600 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-rose-600/30">
            ...
            <button
              onClick={() => setMessageSent(false)}
              className={`px-8 py-3 bg-gradient-to-r from-rose-600 to-cyan-500 hover:from-rose-700 hover:to-cyan-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-rose-600/30 hover:shadow-xl ${bengaliClass}`}
            >
              {t("contactPage.close")}
            </button>
          </motion.div>
      ...
      <section className="relative py-16 lg:py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-[10%] w-[600px] h-[600px] bg-gradient-to-br from-rose-600/20 to-cyan-500/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-[10%] w-[500px] h-[500px] bg-gradient-to-br from-[#FD9A00]/15 to-amber-500/10 rounded-full blur-3xl"></div>
          ...
          <div className="absolute top-20 right-[15%] w-20 h-20 border-2 border-rose-600/20 rounded-2xl rotate-12 animate-float"></div>
          <div className="absolute bottom-32 left-[10%] w-16 h-16 border-2 border-[#FD9A00]/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/3 right-[8%] w-12 h-12 bg-rose-600/10 rounded-xl rotate-45 animate-float" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="container mx-auto px-4 lg:px-16 relative z-10">
          ...
          >
            {/* Premium Badge */}
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 rounded-full bg-gradient-to-r from-gray-900/5 via-rose-600/10 to-gray-900/5 dark:from-white/5 dark:via-rose-600/20 dark:to-white/5 border border-rose-600/20 backdrop-blur-sm">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-rose-600/20 to-cyan-500/20 flex items-center justify-center">
                <LuMessageCircle className="text-rose-600" size={16} />
              </div>
              <span className={`text-sm font-bold text-rose-700 dark:text-rose-500 uppercase tracking-wider ${bengaliClass}`}>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {item.link ? (
                  <a
                    href={item.link}
                    className={`text-gray-900 dark:text-white font-normal text-base hover:text-rose-600 dark:hover:text-rose-500 transition-colors ${bengaliClass}`}
                  >
                    {item.value}
                  </a>
                ) : (
      ...
      <section className="container mx-auto px-4 lg:px-16 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-rose-600/10 to-cyan-500/5 rounded-full blur-2xl"></div>

            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-rose-600/20 to-cyan-500/20 flex items-center justify-center">
                  <LuSend className="text-rose-600" size={18} />
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-rose-600 focus:border-rose-600 dark:focus:border-rose-600 outline-none transition-all text-gray-900 dark:text-white placeholder-gray-400"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-5 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-rose-600 focus:border-rose-600 dark:focus:border-rose-600 outline-none transition-all text-gray-900 dark:text-white placeholder-gray-400 ${bengaliClass}`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full px-5 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-rose-600 focus:border-rose-600 dark:focus:border-rose-600 outline-none transition-all text-gray-900 dark:text-white placeholder-gray-400 resize-none ${bengaliClass}`}
                ...
                <button
                  type="submit"
                  className={`group relative w-full flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-rose-600 to-cyan-500 hover:from-rose-700 hover:to-cyan-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-rose-600/30 hover:shadow-xl overflow-hidden ${bengaliClass}`}
                >
          ...
          >
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-rose-600 via-rose-700 to-cyan-600 rounded-3xl p-8 text-white shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className={`group inline-flex items-center gap-3 px-6 py-3 bg-white text-rose-700 font-bold rounded-xl hover:shadow-xl transition-all hover:scale-105 ${bengaliClass}`}
                >
