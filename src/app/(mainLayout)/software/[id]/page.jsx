                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 bg-white px-8 py-2.5 rounded-md border border-gray-200">
                                ...
                                <span className="font-bold outfit text-gray-900">{software.rating || '0.0'}</span>
                            ...
                            <div className="lg:hidden bg-white dark:bg-slate-900 rounded-md border border-gray-200 dark:border-slate-800 overflow-hidden">
                                ...
                                <div className="p-5">
                                    <div className="flex items-baseline gap-2 mb-4">
                                        ...
                                        {software.offerPrice && software.offerPrice < software.price && (
                                            <span className="text-gray-400 line-through text-sm">৳{software.price?.toLocaleString()}</span>
                                        )}
                                    </div>
