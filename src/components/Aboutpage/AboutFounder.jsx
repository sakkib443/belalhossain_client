                    ...
                    <div className="grid lg:grid-cols-12 items-stretch">
                        ...
                        <div className="lg:col-span-5 relative bg-gray-100/50 dark:bg-[#080808] overflow-hidden flex items-center justify-center p-6 lg:p-8">
                            ...
                            >
                                ...
                                <div className="absolute -inset-10 bg-rose-600/15 rounded-full blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                                ...
                                >
                                    <div className="relative text-center">
                                        <span className={`${headingFont} text-3xl font-black text-rose-600 block leading-none`}>15+</span>
                        ...
                        <div className="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-center relative bg-white dark:bg-[#0a0a0a]">
                            ...
                            <div className="relative z-10">
                                ...
                                >
                                    <div className="h-[2px] w-10 bg-rose-600" />
                                    <span className={`text-[10px] font-black tracking-[0.4em] uppercase text-rose-700 dark:text-rose-500 ${headingFont}`}>Founder's Perspective</span>
                                </motion.div>
                                ...
                                >
                                    EMPOWERING <br />
                                    THE <span className="text-rose-600 italic font-serif">FUTURE</span> OF <br />
                                    DIGITAL MASTERY
                                </motion.h3>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-rose-600 font-bold uppercase tracking-widest text-[9px] mt-1">Founder & CEO, Ejobs IT Ltd</p>
                                    </div>
                                    <div className="flex gap-4">
                                        {[LuLinkedin, LuTwitter, LuGlobe].map((Icon, i) => (
                                            <motion.a
                                                ...
                                                href="#"
                                                className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-white/5 flex items-center justify-center text-gray-400 hover:text-rose-600 border border-gray-100 dark:border-white/10 transition-all shadow-sm"
                                            >
                                                <Icon size={18} />
                                            </motion.a>
                                        ))}
