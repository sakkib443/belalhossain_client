    ...
    return (
        <section ref={sectionRef} className="bg-gray-50 dark:bg-[#050505] relative overflow-hidden transition-colors duration-700">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-20 dark:opacity-40">
                <motion.div
                    style={{ x: xMove }}
                    className="absolute top-1/2 left-0 w-full h-[400px] border-y border-rose-600/10 -translate-y-1/2 flex items-center justify-around overflow-hidden"
                >
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="w-[1px] h-full bg-gradient-to-b from-transparent via-rose-600/20 to-transparent" />
                    ))}
                </motion.div>
            </div>
                        ...
                        >
                            <div className="flex items-center gap-4 mb-8">
                                <div className="p-3 bg-rose-600/10 rounded-2xl">
                                    <LuNetwork className="text-rose-600" size={24} />
                                </div>
                                <span className={`text-sm font-black tracking-[0.3em] text-rose-700 dark:text-rose-500 uppercase ${headingFont}`}>
                            ...
                            <h2 className={`${headingFont} text-6xl lg:text-7xl font-black text-gray-900 dark:text-white leading-[0.9] mb-10`}>
                                BUILT FOR <br />
                                <span className="text-rose-600 italic font-serif">PROFESSIONAL</span> <br />
                                EXCELLENCE
                            </h2>
                        ...
                        {cards.map((card, index) => (
                            <motion.div
                                ...
                                className={`p-10 rounded-[50px] border transition-all duration-500 hover:-translate-y-3 ${card.color === 'teal'
                                    ...
                                    : 'bg-white dark:bg-white/5 text-gray-900 dark:text-white border-gray-100 dark:border-white/10 hover:border-rose-600/30'
                                    }`}
                            >
                                <card.icon className={`${card.color === 'teal' ? 'text-rose-500 dark:text-rose-700' : 'text-rose-600'} mb-8`} size={40} />
