            ...
            <div className="container mx-auto px-4 lg:px-16 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                    ...
                    >
                        ...
                        <h2 className={`${headingFont} text-4xl lg:text-6xl font-black text-gray-900 dark:text-white leading-[0.95] tracking-tight`}>
                            THE STORY <br />
                            IN <span className="text-rose-600 italic font-serif text-5xl lg:text-7xl">NUMBERS</span>
                        </h2>
                    </motion.div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-gray-100 dark:border-white/5">
                    {stats.map((stat, index) => (
                        ...
                        >
                            {/* Sharp Hover Effect */}
                            <div className="absolute top-0 left-0 w-full h-[2px] bg-rose-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left" />

                            <h4 className={`${headingFont} text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-4 tracking-tighter group-hover:text-rose-600 transition-colors duration-500`}>
                                {stat.target}
                            </h4>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                            <motion.div
                                ...
                                className="w-24 h-24 lg:w-32 lg:h-32 rounded-full bg-rose-600/90 backdrop-blur-md flex items-center justify-center shadow-2xl relative mb-10 group/play cursor-pointer"
                            >
                                <div className="absolute inset-0 rounded-full bg-rose-600 animate-ping opacity-20" />
                            ...
                            <h3 className={`${headingFont} text-2xl lg:text-4xl font-black text-white tracking-tight uppercase`}>
                                Experience the <span className="text-rose-600">Journey</span>
                            </h3>
                        </div>
                    </motion.div>
                </div>
