        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`relative p-2.5 rounded-xl transition-all duration-300 overflow-hidden group ${isDark
              ? 'bg-gradient-to-br from-[#ED1C3E] to-[#2dd4bf] text-white shadow-lg shadow-[#ED1C3E]/30 hover:shadow-[#ED1C3E]/50'
              ...
              <div className={`absolute right-0 top-full mt-2 w-56 rounded-2xl shadow-2xl border overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 ${isDark
                ...
                <div className={`p-4 border-b ${isDark
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#ED1C3E] to-[#2dd4bf] flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-[#ED1C3E]/25">
                      {user?.firstName?.[0] || 'A'}
                    </div>
                    <div>
