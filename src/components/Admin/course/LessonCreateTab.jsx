        ...
        <div className="max-w-5xl mx-auto space-y-5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#FD9A00] hover:bg-[#f59e0b] text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-all"
                        >
                            <FiCheck size={16} />
                            Finish
                        </button>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 space-y-4">
                <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#FD9A00] to-[#f59e0b] flex items-center justify-center">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div className="grid grid-cols-4 gap-3 text-center">
                                    <div className="p-2 bg-white rounded-lg">
                                        <p className="text-xl font-bold text-[#FD9A00]">{formData.videoUrl ? '1' : '0'}</p>
