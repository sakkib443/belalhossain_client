        ...
        <div className="max-w-4xl mx-auto space-y-5">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FD9A00] to-[#2dd4bf] flex items-center justify-center text-white">
                            <FiBook size={18} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#FD9A00] hover:bg-[#f59e0b] text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-all disabled:opacity-50"
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {createdModules.map((mod, idx) => (
                                    <div key={mod._id || idx} className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-lg border border-gray-200">
                                        <span className="w-5 h-5 rounded bg-[#FD9A00] text-white flex items-center justify-center font-bold text-xs">
                                            {mod.order}
                                        </span>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-5 rounded-xl border border-gray-200 space-y-4">
                <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#FD9A00] to-[#2dd4bf] flex items-center justify-center">
