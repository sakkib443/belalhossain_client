        ...
        {!loading && filteredCourses.length > visibleItems && (
          <>
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-11 h-11 bg-white border border-gray-200 rounded-full shadow-lg flex items-center justify-center text-gray-500 hover:bg-[#ED1C3E] hover:text-white hover:border-[#ED1C3E] hover:shadow-xl transition-all duration-300 disabled:opacity-50"
            >
            ...
            <button
              onClick={handleNext}
              disabled={isAnimating}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-11 h-11 bg-white border border-gray-200 rounded-full shadow-lg flex items-center justify-center text-gray-500 hover:bg-[#ED1C3E] hover:text-white hover:border-[#ED1C3E] hover:shadow-xl transition-all duration-300 disabled:opacity-50"
            >
