            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 border-b border-gray-100 pb-8">
                ...
                <div className="w-full md:w-auto">
                    <button
                        ...
                        className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-gray-900 hover:bg-rose-700 text-white font-semibold rounded-lg transition-colors shadow-lg shadow-gray-200"
                    >
                        ...
                        <div key={review._id} className="p-6 bg-gray-50/50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-md transition-all">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-200/50">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 text-gray-400 hover:text-rose-700 text-xs font-medium transition-colors ml-auto"
                                >
                                    <FaThumbsUp size={12} />
