    ...
    <div className="relative bg-transparent cursor-pointer transition-transform duration-700 ease-in-out hover:scale-[1.03] hover:shadow-xl group perspective rounded-xl">
      <div className="rounded-md border border-gray-200 bg-white p-2 text-gray-800 overflow-hidden transition-all duration-700 ease-in-out">
        ...
        <div className="flex justify-between gap-2 items-center mt-2 mb-2">
          <Link
            href={`/${id}`}
            className="flex gap-2 text-xl items-center border bg-[#ED1C3E] border-[#ED1C3E] px-4 ml-2 py-2 rounded-md"
          >
          ...
          >
            <div className="flex gap-1 text-xl items-center border border-[#ED1C3E] px-4 py-2 mr-6 rounded-md hover:bg-[#e0f7f5] cursor-pointer transition">
              <FaWhatsapp className="text-xl text-[#ED1C3E] font-medium" />
              <p className="text-[#ED1C3E] work text-[15px] tracking-tight">
                Get Course
              </p>
            </div>
          </Link>
